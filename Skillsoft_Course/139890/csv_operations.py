...
my_file = os.path.join('C:\AASICLAB_KVINT_TEST_DEV\Python\Skillsoft_Course',working_dir,file_name)
my_new_file = os.path.join('C:\AASICLAB_KVINT_TEST_DEV\Python\Skillsoft_Course',working_dir,new_file_name)
